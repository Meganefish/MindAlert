...
public class MusicExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private List<String> groupList; // 分组名称
    private HashMap<String, List<String>> itemList; // 每个组对应的子项

    public MusicExpandableListAdapter(Context context, List<String> groupList, HashMap<String, List<String>> itemList) {
